...
const val EXTRA_WALLPAPER_URI = "com.ternaryop.photoshelf.imageviewer.service.extra.WALLPAPER_URI"
...
class WallpaperIntentService : IntentService("wallpaperIntent") {
    ...
    private fun changeWallpaper(intent: Intent) {
        try {
            val imageUrl = intent.getParcelableExtra<Uri>(EXTRA_WALLPAPER_URI) ?: return
