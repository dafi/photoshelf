...
class PhotoSortSwitcher {
    ...
    private inner class TagNameSortable(isDefaultAscending: Boolean)
    ...
    private inner class LastPublishedTagSortable(isDefaultAscending: Boolean)
    ...
    private inner class UploadTimeSortable(isDefaultAscending: Boolean)
