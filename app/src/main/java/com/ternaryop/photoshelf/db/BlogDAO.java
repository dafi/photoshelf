...
public class BlogDAO extends AbsDAO<Blog> implements BaseColumns {
     ...
     */
    BlogDAO(SQLiteOpenHelper dbHelper) {
        super(dbHelper);
    }
    ...
    @Override
    public ContentValues getContentValues(Blog blog) {
        ContentValues v = new ContentValues();

        v.put(NAME, blog.getName());
